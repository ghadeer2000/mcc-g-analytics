...
class cat_Food : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cat__food)
        firebaseStorage = FirebaseStorage.getInstance().reference.child("img/food3.jpg")
        ...
        progressDialog.show()
        putFile("food3","jpg",shawarma)

        shawarma.setOnClickListener {
            var i = Intent(this,show_Chategory::class.java)
            i.putExtra("res","img/food3.jpg")
            i.putExtra("head","Shawarma")
            i.putExtra("del","delicious food")
            i.putExtra("prefix","food3")
            i.putExtra("sufix","jpg")

            startActivity(i)
        }

        firebaseStorage = FirebaseStorage.getInstance().reference.child("img/food1.jpg")

        putFile("food1","jpg",pizza)



        pizza.setOnClickListener {
            var i = Intent(this,show_Chategory::class.java)
            i.putExtra("res","img/food1.jpg")
            i.putExtra("head","Pizza")
            i.putExtra("del","delicious food")
            i.putExtra("prefix","food1")
            i.putExtra("sufix","jpg")

            startActivity(i)
        }
        firebaseStorage = FirebaseStorage.getInstance().reference.child("img/food2.jpg")

        putFile("food2","jpg",burger)
        burger.setOnClickListener {
            var i = Intent(this,show_Chategory::class.java)
            i.putExtra("res","img/food2.jpg")
            i.putExtra("head","Burger")
            i.putExtra("del","delicious food")
            i.putExtra("prefix","food2")
            i.putExtra("sufix","jpg")

            startActivity(i)
        }
        callAnalytic(id,"Cat_food")
...
//        Toast.makeText(this,"$hour:$minute:$second",Toast.LENGTH_SHORT).show()
        ...
        addScreen(id,"Cat_food","$hour:$minute:$second")
